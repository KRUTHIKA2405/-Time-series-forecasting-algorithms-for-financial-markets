...
prep = prepare_dataset(bars, features=tuple(req.features), label_mode=req.label_mode,
...
hist = model.fit(prep.Xtr, prep.ytr, validation_data=(prep.Xv, prep.yv),
epochs=req.epochs, batch_size=req.batch_size, verbose=0, callbacks=cb)
